...
Set: [HBMAME - Update ROMs (v0.245 to v0.245.2)](http://mgnet.me/eqUB6nW)<br>
Datfile: [HBMAME - Update ROMs (v0.245 to v0.245.2)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME - Update ROMs (v0.245 to v0.245.2).zip)<br>

<b>HBMAME Machines, BIOS and Devices sets:</b>

HBMAME ROMs (bios-devices)<br>
Set: [HBMAME 0.245.2 ROMs (bios-devices)](http://mgnet.me/eqUB6na)<br>
Datfile: [HBMAME 0.245.2 ROMs (bios-devices)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 ROMs (bios-devices).zip)<br>
...
HBMAME ROMs<br>
Set: [HBMAME 0.245.2 ROMs (merged)](http://mgnet.me/eqUB6nc)<br>
Datfile: [HBMAME 0.245.2 ROMs (merged)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 ROMs (merged).zip)<br>
HBMAME CHDs<br>
Datfile: [HBMAME 0.245.2 CHDs (merged)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 CHDs (merged).zip)<br>
Datfile (dir2dat): [HBMAME 0.245.2 CHDs (merged) (dir2dat)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 CHDs (merged) (dir2dat).zip)<br>

<b>HBMAME Rollback full sets:</b>

HBMAME Rollback ROMs<br>
Set: [HBMAME 0.245.2 Rollback ROMs](http://mgnet.me/eqUB6nX)<br>
Datfile: [HBMAME 0.245.2 Rollback ROMs](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 Rollback ROMs.zip)<br>
HBMAME Rollback CHDs<br>
Datfile: [HBMAME 0.245.2 Rollback CHDs](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 Rollback CHDs.zip)<br>
Datfile (dir2dat): [HBMAME 0.245.2 Rollback CHDs (dir2dat)](https://github.com/pleasuredome/pleasuredome/raw/gh-pages/hbmame/HBMAME 0.245.2 Rollback CHDs (dir2dat).zip)<br>
